...
def app_bootstrap():
    ...
    # === 임시 샘플 경로 데이터 (Firestore 없이 테스트용) ===
    sample_route = {
        "routeId": "ROUTE_001",
        "routeName": "테스트 경로",
        "routeStrategy": "test",
        "routeProfile": None,
        "directDistanceMeter": 850,
        "distanceBudgetMeter": 2000,
        "budgetMultiplier": 1.5,
        "intermediateSensorCount": 2,
        "estimatedDistanceMeter": 920,
        "estimatedTimeMinute": 13,
        "routePoints": [
            [36.628123, 127.457891],
            [36.62785, 127.45620],
            [36.62720, 127.45550],
            [36.62680, 127.45510]
        ],
        "sensors": [
            {
                ...
                "latitude": 36.62785,
                "longitude": 127.45620,
                "routeLatitude": 36.62785,
                "routeLongitude": 127.45620,
                "missionRadiusMeter": 50,
                "collectedCountToday": 3,
                "visitOrder": 1,
                "isTarget": False
            },
            {
                ...
                "latitude": 36.62680,
                "longitude": 127.45510,
                "routeLatitude": 36.62680,
                "routeLongitude": 127.45510,
                "missionRadiusMeter": 50,
                "collectedCountToday": 1,
                "visitOrder": 2,
                "isTarget": True
            }
        ],
    ...
    return success(
        {
            ...
            "weather": {
                "target": "ALL",
                "average": {"temperature": 24.5, "co2": 650},
                "sensorCount": 2,
                "sensors": []
            },
            "routes": [sample_route],     # ← 샘플 경로 1개 반환
            "reward": {
                "user": {"userId": "USER_001", "totalPoint": 1250},
                "myRanking": {"rank": 1},
                "rankings": []
            }
        },
        "앱 초기 데이터 조회에 성공했습니다. (샘플 경로)"
    )
